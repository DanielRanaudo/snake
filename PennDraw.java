...
/**
 *  The {@code PennDraw} class provides static methods for creating drawings
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code PennDraw.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, either download
 *  <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 *  and add to your Java classpath or download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/PennDraw.java">PennDraw.java</a>
 *  and put a copy in your working directory.
 *  <p>
 *  Now, cut-and-paste the following short program into your editor:
 *  <pre>
 *   public class TestPennDraw {
 *       public static void main(String[] args) {
 *           PennDraw.setPenRadius(0.05);
 *           PennDraw.setPenColor(PennDraw.BLUE);
 *           PennDraw.point(0.5, 0.5);
 *           PennDraw.setPenColor(PennDraw.MAGENTA);
 *           PennDraw.line(0.2, 0.2, 0.8, 0.2);
 *       }
 *   }
 *  </pre>
 ...
 *  The methods {@code PennDraw.line()} and {@code PennDraw.point()}
 *  draw lines and points; the methods {@code PennDraw.setPenRadius()}
 *  and {@code PennDraw.setPenColor()} control the line thickness and color.
 *  <p>
 ...
 *  and represented in degrees. For example, {@code PennDraw.arc(0.0, 0.0, 1.0, 0, 90)}
 ...
 *  </ul>
 *  <p>
 *  For example, {@code PennDraw.setPenRadius(0.01)} makes
 ...
 *  and {@link #BLUE}.
 *  For example, {@code PennDraw.setPenColor(PennDraw.RED)} sets the
 *  pen color to red.
 *  <p>
 *  <b>Window title.</b>
 ...
 *  For example, {@code PennDraw.setCanvasSize(800, 800)}
 ...
 *  leave a small margin, you can call {@code PennDraw.setScale(-.05, 1.05)}.
 *  <p>
 ...
 *   PennDraw.text(0.5, 0.5, "Hello, World");
 *  </pre>
 *  <p>
 *  <b>Images.</b>
 ...
 *
 *  <p><b>File formats.</b>
 *  The {@code PennDraw} class supports reading and writing images to any of the
 ...
 *  {@code PennDraw.clear(PennDraw.LIGHT_GRAY)} clears the canvas to a shade
 *  of gray. To make the background transparent,
 *  call {@code PennDraw.clear(PennDraw.TRANSPARENT)}.
 *
 *  <p>
...
public final class PennDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
     ...
     * To make the background transparent, use {@code PennDraw.TRANSPARENT}.
     *
     ...
     * {@code PennDraw.BLACK}, {@code PennDraw.WHITE}, {@code PennDraw.RED},
     * {@code PennDraw.GREEN}, and {@code PennDraw.BLUE}.
     *
    ...
    private static Image getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to PennDraw)
        if (icon.getImageLoadStatus() != MediaTracker.COMPLETE) {
...
*/
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (selectedDirectory != null && selectedFilename != null) {
            try {
                PennDraw.save(selectedDirectory + selectedFilename);
            }
    ...
    public void mousePressed(MouseEvent event) {
        synchronized (MOUSE_LOCK) {
            mouseX = PennDraw.userX(event.getX());
            mouseY = PennDraw.userY(event.getY());
            isMousePressed = true;
        }
    }
     ...
     */
    public static void main(String[] args) {
        PennDraw.square(0.2, 0.8, 0.1);
        PennDraw.filledSquare(0.8, 0.8, 0.2);
        PennDraw.circle(0.8, 0.2, 0.2);

        PennDraw.setPenColor(PennDraw.BOOK_RED);
        PennDraw.setPenRadius(0.02);
        PennDraw.arc(0.8, 0.2, 0.1, 200, 45);
        ...
        PennDraw.text(0.8, 0.8, "white text");
    }
